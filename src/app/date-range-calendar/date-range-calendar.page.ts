...
import { Content, ModalController, NavParams, DomController } from '@ionic/angular';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { Subject, Subscription } from 'rxjs';
import { filter, distinctUntilChanged, tap } from 'rxjs/operators';
import * as moment from 'moment';
import { month, CalendarService } from '../../service/calendar.service';
...
export class DateRangeCalendarPage implements OnInit,AfterContentInit {
  ...
  @ViewChild('scrollMe') scrollMe: Content;
