(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main-main-module~qlns-ChamCong-dataChamCong-module"],{
...
/***/ "./src/core/modal/Announcement.ts":
/*!****************************************!*\
  !*** ./src/core/modal/Announcement.ts ***!
  \****************************************/
...
/*!****************************************!*\
  !*** ./src/service/signalR.service.ts ***!
  \****************************************/
/*! exports provided: AUTH_KEY, SignalRService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _src_AppSettings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../src/AppSettings */ "./src/AppSettings.ts");
/* harmony import */ var _src_core_modal_Announcement__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../src/core/modal/Announcement */ "./src/core/modal/Announcement.ts");
...
var SignalRService = /** @class */ (function () {
    ...
    // private _localStorageService: LocalStorageService
        ...
        this.receivedAnouncementObject = new _src_core_modal_Announcement__WEBPACK_IMPORTED_MODULE_4__["Announcement"]();
        this.announcement$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.connection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_1__["HubConnectionBuilder"]()
            .withUrl(_src_AppSettings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"].API_ENDPOINT + "/signalRMobile")
            .build();
        this.connect();
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 3];
                    case 3:
                        this.connection.on('ReceiveMessage', function (recipientId, message1) {
                            console.log(recipientId);
                            console.log(message1);
                            Object.assign(message1, { recipientId: recipientId });
                            _this.announcement$.next(message1);
                        });
                        return [2 /*return*/];
                }
            });
    ...
    SignalRService.prototype.retrieveMappedObject = function () {
...
//# sourceMappingURL=main-main-module~qlns-ChamCong-dataChamCong-module.js.map